...
if(mysqli_query($conn,$sql)==TRUE){
  ...
  echo"<script>alert('Thank you for your time to complete question_3');window.location='question_4.php'</script>";
...
<body class="w3-tangerine">
	...
	<form name="quiz-form" method="POST" enctype="multipart/form-data" onsubmit="return validate()">
		...
		<p><badge  class="w3-badge w3-teal"><b>3</b></badge></p>
		...
		<div class="w3-row w3-padding w3-animate-zoom">
			...
			<div class="w3-col s10 m10 l10 w3-badge w3-round w3-teal" style="padding:3px;width:60%">
				<div class="w3-container w3-card-4 " style="border:1px solid white"><label><b>Prospective Client Character and Integrity</b></label>
...
<p><b>If other auditors/accountants have declined to serve the
		prospective clients,or if opinion shopping or other similar
		motivations for change are suspected,have you 
		documented the risk involved and carefully considered
		why you should accept the the engagement?</b></b>&nbsp  &nbsp
	        <input class="w3-radio" type="radio" name="radio1" value="yes" id="checked" ><b>yes</b>
			<input class="w3-radio" type="radio" name="radio1" value="no" id="checked1" ><b>No</b>
			<input class="w3-radio" type="radio" name="radio1" value="na" id="checked2" ><b>NA</b>
			&nbsp &nbsp<label id="radio1_error" class="w3-animate-zoom"></label></p>
