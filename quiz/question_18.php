...
if(mysqli_query($conn,$sql)==TRUE){
  ...
  echo"<script>alert('Thank you for your time to complete question_18');window.location='question_19.php'</script>";
...
<body class="w3-tangerine">
	...
	<form name="quiz-form" method="POST" enctype="multipart/form-data" onsubmit="return validate()">
		...
		<p><badge  class="w3-badge w3-teal"><b>18</b></badge></p>
...
<p><b>Are there specifics areas of the financial statements or specific accounts that deserve extra attention?
...
<!---comment & file------>
<p><b>If so document the details.</b></p>
