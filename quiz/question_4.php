...
$sql="insert into question(qn_id,qn_radio2,qn_radio3,qn_radio4,qn_radio5,qn_radio6,qn_radio7,qn_number,qn_comment)values";
$sql.="(null,'$radio2','$radio3' ,'$radio4','$radio5','$radio6','$radio7','$number','$comment')";
...
if(mysqli_query($conn,$sql)==TRUE){
  ...
  echo"<script>alert('Thank you for your time to complete question_4');window.location='question_5.php'</script>";
...
<body class="w3-tangerine">	
	<div class="w3-container">
		...
		<p><badge  class="w3-badge w3-teal"><b>4</b></badge></p>
...
<div class="w3-col s12 m12 l12  w3-round" style="padding-left:15px">
	<p><b>Have you contacted the predecessor auditor or
                accountant and enquired about:</b>
        </p>
 
                  
<p>         <b>(a)</b> Access to the prospective client's working papers
...
<p>         <b>(c)</b>Any difference of opinion or disagreements,
...
<p>         <b>(d)</b>Integrity of management and board
 ...
 <p>        <b>(e)</b> Reasons for the change; and
 ...
 <p>        <b>(f)</b>Any unreasonable demands or lack of co-operations?
