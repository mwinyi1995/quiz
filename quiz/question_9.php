...
if(mysqli_query($conn,$sql)==TRUE){
  ...
  echo"<script>alert('Thank you for your time to complete question_9');window.location='question_10.php'</script>";
...
<body class="w3-tangerine">
	...
	<form name="quiz-form" method="POST" enctype="multipart/form-data" onsubmit="return validate()">
		...
		<p><badge  class="w3-badge w3-teal"><b>9</b></badge></p>
		...
		<div class="w3-row w3-padding w3-animate-zoom">
			...
			<div class="w3-col s10 m10 l10 w3-badge w3-round w3-teal" style="padding:3px;width:60%">
				<div class="w3-container w3-card-4 " style="border:1px solid white"><label><b>Previous Financial Statements</b></label>
...
<p><b>In the instance of any audit,are any additional audit
			procedures required in relation to key prior-year
			transaction and/or balances to reduce the risk of
			misstatement of the opening account balances?</b>
...
<!---comment & file------>
<p><b>if yes,add reference for those procedures</b></p>
