...
if(mysqli_query($conn,$sql)==TRUE){
  ...
  echo"<script>alert('Thank you for your time to complete question_1');window.location='question_2.php'</script>";
...
<body class="w3-tangerine">
	...
	<form name="quiz-form" method="POST" enctype="multipart/form-data" onsubmit="return validate()">
		...
		<p><badge  class="w3-badge w3-teal"><b>1</b></badge></p>
...
<div  class="w3-col s12 m12 l12 " style="padding-left:15px;">
<p><b>Do you,trusted clients,or colleagues know the client ?</b>&nbsp  &nbsp
