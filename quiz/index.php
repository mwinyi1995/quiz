...
<p class="w3-center w3-text-grey"><b>WELCOME TO MY SHORT SURVEY</b></p>
  ...
  <input class="w3-input w3-border" type="password" name="password" placeholder="Your password">
  <label id="pass_error"></label> <br/>
  <input class="w3-input w3-border" type="password" name="repassword" placeholder="retype password">
