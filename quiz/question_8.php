...
if(mysqli_query($conn,$sql)==TRUE){
  ...
  echo"<script>alert('Thank you for your time to complete question_8');window.location='question_9.php'</script>";
...
<body class="w3-tangerine">	
	<div class="w3-container">
		...
		<p><badge  class="w3-badge w3-teal"><b>8</b></badge></p>
		...
		<div class="w3-row w3-padding w3-animate-zoom">
			...
			<div class="w3-col s10 m10 l10 w3-badge w3-round w3-teal" style="padding:3px;width:60%">
				<div class="w3-container " style="border:1px solid white"><label><b>Previous Financial Statements</b></label>
...
<div class="w3-col s12 m12 l12  w3-round" style="padding-left:15px">
 <p><b>Have you determined the significant accounting policies
			and methods used in prior year's finacial statements,
			and considered whether they appropriate and
			consistenly applied?</b>
 </p>
...
<p>         <b>(a)</b>Significant valuations,such as allowance for doubtful 
	         accounts,inventory,and investments
...
<p>         <b>(b)</b>Amortization policies and rates;
