...
if(mysqli_query($conn,$sql)==TRUE){
  ...
  echo"<script>alert('Thank you for your time to complete question_21');window.location='question_22.php'</script>";
...
<body class="w3-tangerine">
	...
	<form name="quiz-form" method="POST" enctype="multipart/form-data" onsubmit="return validate()">
		...
		<p><badge  class="w3-badge w3-teal"><b>21</b></badge></p>
...
<p><b>Are you satisfied that the prospective client is both willing and able to pay an acceptance fee?</b>
