...
if(mysqli_query($conn,$sql)==TRUE){
  ...
  echo"<script>alert('Thank you for your time to complete question_25');window.location='question_26.php'</script>";
...
<body class="w3-tangerine">
	...
	<form name="quiz-form" method="POST" enctype="multipart/form-data" onsubmit="return validate()">
		...
		<p><badge  class="w3-badge w3-teal"><b>25</b></badge></p>
		...
		<div class="w3-row w3-padding w3-animate-zoom">
			...
			<div class="w3-col s10 m10 l10 w3-badge w3-round w3-teal" style="padding:3px;width:60%">
				<div class="w3-container w3-card-4 " style="border:1px solid white"><label><b>Other</b></label>
...
<p><b>Are there any additional client acceptance issues to consider,such as more detailed assessment of independence and risk factors?
	    ...
	    <input class="w3-radio" type="radio" name="radio1" value="yes" id="checked" >yes
			...
			<input class="w3-radio" type="radio" name="radio1" value="na" id="checked2" >NA</b><br/>
			<label id="radio1_error" class="w3-animate-zoom"></label></p>


<!---comment & file------>
<p><b>If so, document the issues and your handling of these issues.</b></p>
