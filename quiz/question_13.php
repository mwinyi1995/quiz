...
if(mysqli_query($conn,$sql)==TRUE){
  ...
  echo"<script>alert('Thank you for your time to complete question_13');window.location='question_14.php'</script>";
...
<body class="w3-tangerine">
	...
	<form name="quiz-form" method="POST" enctype="multipart/form-data" onsubmit="return validate()">
		...
		<p><badge  class="w3-badge w3-teal"><b>13</b></badge></p>
...
<p><b>Have any areas been identified that require specialized knowledge?
			...
			<p><b>if so,can the required knowledge be readily obtained ?
