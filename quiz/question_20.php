...
if(mysqli_query($conn,$sql)==TRUE){
  ...
  echo"<script>alert('Thank you for your time to complete question_20');window.location='question_21.php'</script>";
...
<body class="w3-tangerine">
	...
	<form name="quiz-form" method="POST" enctype="multipart/form-data" onsubmit="return validate()">
		...
		<p><badge  class="w3-badge w3-teal"><b>20</b></badge></p>
...
<p><b>Are you satisfied that there is no significant reason to doubt the prospective client's ability to continue in existence for the foreseeable future(at least one year) ?</b>
	    ...
	    <input class="w3-radio" type="radio" name="radio1" value="yes" id="checked" >yes
			...
			<input class="w3-radio" type="radio" name="radio1" value="na" id="checked2" >NA
