...
$sql="insert into question(qn_id,qn_radio2,qn_radio3,qn_radio4,qn_number,qn_comment)values";
$sql.="(null,'$radio2','$radio3','$radio4','$number','$comment')";
...
if(mysqli_query($conn,$sql)==TRUE){
  ...
  echo"<script>alert('Thank you for your time to complete question_6');window.location='question_7.php'</script>";
...
<body class="w3-tangerine">	
	<div class="w3-container">
		...
		<p><badge  class="w3-badge w3-teal"><b>6</b></badge></p>
...
<div class="w3-col s12 m12 l12  w3-round" style="padding-left:15px">
	<p><b>Have you obtained and reviewed copies of:</b>
        </p>
                  
<p>         <b>(a)</b>Finacial statements for at least the previous two years;
...
<p>         <b>(b)</b>Tax returns and related assessments for the previous two years;
            ...
            <label id="radio3_error" class="w3-animate-zoom"></label> and
</p>

<p>         <b>(c)</b>Management letters for the previous two or three years ?
