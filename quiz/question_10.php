...
if(mysqli_query($conn,$sql)==TRUE){
  ...
  echo"<script>alert('Thank you for your time to complete question_10');window.location='question_11.php'</script>";
...
<body class="w3-tangerine">
	...
	<form name="quiz-form" method="POST" enctype="multipart/form-data" onsubmit="return validate()">
		...
		<p><badge  class="w3-badge w3-teal"><b>10</b></badge></p>
...
<p><b>Have you determine whether a disclaimer of opinion
			will be necessary,due to an inability to obtain sufficient
			assurance regarding opening balances?<br/>
			...
			<input class="w3-radio" type="radio" name="radio1" value="na" id="checked2" ><b>NA</b></b>
