...
$sql="insert into question(qn_id,qn_radio1,qn_radio2,qn_radio3,qn_radio4,qn_radio5,qn_radio6,qn_radio7,qn_number,qn_comment)values";
$sql.="(null,'$radio1','$radio2','$radio3' ,'$radio4','$radio5','$radio6','$radio7','$number','$comment')";
...
if(mysqli_query($conn,$sql)==TRUE){
  ...
  echo"<script>alert('Thank you for your time to complete question_2');window.location='question_3.php'</script>";
...
<body class="w3-tangerine">	
	<div class="w3-container">
		...
		<p><badge  class="w3-badge w3-teal"><b>2</b></badge></p>
		...
		<div class="w3-row w3-padding w3-animate-zoom">
			...
			<div class="w3-col s10 m10 l10 w3-badge w3-round w3-teal" style="padding:3px;width:60%">
				<div class="w3-container " style="border:1px solid white"><label><b>Prospective Client Character and Integrity</b></label>
...
<div class="w3-col s12 m12 l12  w3-round" style="padding-left:15px">
 <p><b>Are you satisfied that there have been no events or
                 circumstances that cast doubt on the integrity of
                 prospective client's owners,board members,or
                managements?</p>
...
<div class="w3-col s12 m12 l12  w3-round" style="padding-left:15px">
 <p><b> specifically,are you reasonably satisfied that none of the following exist?</b></p>
                  
<p>         <b>(a)</b>convictions and regulatory sanctions, 
...
<p>         <b>(b)</b>Suspicion of illegal acts or fraud,
...
<p>         <b>(c)</b>Ongoing investigations,
...
<p>         <b>(d)</b> Management membership in proffesional   organizations that are not in good standing,
 ...
 <p>        <b>(f)</b> Close association with people/companies with questionable ethics.
...
<br/>
       <p><b>Describe the methods used to obtain evidence of theses
	risk;Document any evidence obtained that is relevant in
	assessing this risk.</b></p>
