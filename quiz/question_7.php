...
if(mysqli_query($conn,$sql)==TRUE){
  ...
  echo"<script>alert('Thank you for your time to complete question_7');window.location='question_8.php'</script>";
...
<body class="w3-tangerine">	
	<div class="w3-container">
		...
		<p><badge  class="w3-badge w3-teal"><b>7</b></badge></p>
		...
		<div class="w3-row w3-padding w3-animate-zoom">
			...
			<div class="w3-col s10 m10 l10 w3-badge w3-round w3-teal" style="padding:3px;width:60%">
				<div class="w3-container " style="border:1px solid white"><label><b>Previous Financial Statement</b></label>
...
<div class="w3-col s12 m12 l12  w3-round" style="padding-left:15px">
	<p><b>Assuming you can gain access,have you reviewed prior-period working papers prepared by the previous auditor or accountant to:</b>
        </p>
 
                  
<p>         <b>(a)</b>Assess the reasonableness of closing balance of prior periods,paying particular attention to           significant accounts,to determine if any need to be restarted;<br/>
...
<p>         <b>(b)</b>Determine if the previous auditor/accountant identified any material misstatements:
...
<p>         <b>(c)</b>Determine the effect on the current year of any immaterial misstatements not adjusted in the prior year; and
...
<p>         <b>(d)</b>Assess the frequency of management's accounting
			system by reviewing prior auditor/accountant's
			adjusting journal entries and management letters ?<br/>
