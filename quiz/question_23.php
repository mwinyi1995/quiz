...
if(mysqli_query($conn,$sql)==TRUE){
  ...
  echo"<script>alert('Thank you for your time to complete question_23');window.location='question_24.php'</script>";
...
<body class="w3-tangerine">
	...
	<form name="quiz-form" method="POST" enctype="multipart/form-data" onsubmit="return validate()">
		...
		<p><badge  class="w3-badge w3-teal"><b>23</b></badge></p>
...
<p><b>Are there appropriate criteria (for example,IFRSs) against which the subject matter of engagement can be
evaluated?
